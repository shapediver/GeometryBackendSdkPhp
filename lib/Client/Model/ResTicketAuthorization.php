...
/**
 * ResTicketAuthorization Class Doc Comment
 *
 * @category Class
 * @package  ShapeDiver\GeometryApiV2\Client
 * @author   OpenAPI Generator team
 ...
 */
class ResTicketAuthorization implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResTicketAuthorization';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['backendaccess'] === null) {
            $invalidProperties[] = "'backendaccess' can't be null";
        }
     ...
     * Sets accessdomains
     *
     * @param string[] $accessdomains List of domains (origins) this model is limited to (is ignored in case `model.pub` is true).
     *
     * @return self
     */
     ...
     * Sets backendaccess
     *
     * @param bool $backendaccess Should backend access to the model be allowed.
     *
     * @return self
     */
     ...
     * Sets pub
     *
     * @param bool $pub If this model allows public access (ignore `model.accessdomains`)?
     *
     * @return self
     */
