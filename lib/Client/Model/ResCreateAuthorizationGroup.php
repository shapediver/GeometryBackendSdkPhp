...
/**
 * ResCreateAuthorizationGroup Class Doc Comment
 *
 * @category Class
 * @package  ShapeDiver\GeometryApiV2\Client
 * @author   OpenAPI Generator team
 ...
 */
class ResCreateAuthorizationGroup implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResCreateAuthorizationGroup';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['authGroup'] === null) {
            $invalidProperties[] = "'authGroup' can't be null";
        }
     ...
     * Sets authGroup
     *
     * @param string $authGroup The auth-group to use for ticked-based authentication.
     *
     * @return self
     */
