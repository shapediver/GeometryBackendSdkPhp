...
class ReqModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('withRepo', $data ?? [], null);
    ...
    */
     ...
     * Sets prevId
     *
     * @param string|null $prevId The Model ID of the previous version of this model. This property is applicable only when creating a new model and cannot be used in conjunction with `prev_id`.
     *
     * @return self
     */
     ...
     * @return bool|null
     */
    public function getWithRepo()
    {
        return $this->container['withRepo'];
    }

    /**
     * Sets withRepo
     *
     * @param bool|null $withRepo If set to `true`, a new repository will be created for the model. This property is applicable only when creating a new model and cannot be used in conjunction with `prev_id`.
     *
     * @return self
     */
    public function setWithRepo($withRepo)
    {
        if (is_null($withRepo)) {
            throw new \InvalidArgumentException('non-nullable withRepo cannot be null');
        }
        $this->container['withRepo'] = $withRepo;
     ...
     * Sets pub
     *
     * @param bool|null $pub Allows public access (ignore `accessdomains`).
     *
     * @return self
     */
