 ...
 */
class ResOutput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResOutput';
    ...
    */
     ...
     * Sets group
     *
     * @param \ShapeDiver\GeometryApiV2\Client\Model\CommonsGroup|null $group Group information of an output definition.
     *
     * @return self
     */
     ...
     * Sets typeId
     *
     * @param string|null $typeId Type-specific ID of the output. In case of outputs defined by a single component, this corresponds to the component’s uuid.
     *
     * @return self
     */
     ...
     * Sets typeName
     *
     * @param string|null $typeName Type-specific name of the output. In case of outputs defined by a single component, this corresponds to the component’s name (NOT its nickname).
     *
     * @return self
     */
    ...
    public function setDelay($delay)
    {
        ...
        if (($delay < 0)) {
            throw new \InvalidArgumentException('invalid value for $delay when calling ResOutput., must be bigger than or equal to 0.');
        }
