...
/**
 * ResGetCleanupStatus Class Doc Comment
 *
 * @category Class
 * @package  ShapeDiver\GeometryApiV2\Client
 * @author   OpenAPI Generator team
 ...
 */
class ResGetCleanupStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResGetCleanupStatus';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['cleanup'] === null) {
            $invalidProperties[] = "'cleanup' can't be null";
        }
     ...
     * Gets cleanup
     *
     * @return \ShapeDiver\GeometryApiV2\Client\Model\ResModelCleanupProcess[]
     */
     ...
     * Sets cleanup
     *
     * @param \ShapeDiver\GeometryApiV2\Client\Model\ResModelCleanupProcess[] $cleanup Model cleanup information.
     *
     * @return self
     */
