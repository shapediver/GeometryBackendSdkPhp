 ...
 */
class ResTicket implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResTicket';
    ...
    protected static $openAPITypes = [
        ...
        'until' => 'string',
        'useId2' => 'bool',
        'type' => '\ShapeDiver\GeometryApiV2\Client\Model\ResTicketType',
        'modelId' => 'string'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['accessdomains'] === null) {
            $invalidProperties[] = "'accessdomains' can't be null";
        }
        ...
        if ($this->container['useId2'] === null) {
            $invalidProperties[] = "'useId2' can't be null";
        }
     ...
     * Sets accessdomains
     *
     * @param string[] $accessdomains List of domains (origins) this ticket should be limited to; may be empty.
     *
     * @return self
     */
     ...
     * Sets author
     *
     * @param bool $author Should this ticket provide access to model authoring (allows to change configuration)?
     *
     * @return self
     */
    ...
    public function setUntil($until)
    {
        ...
        if ((!preg_match("/^\\d{14}$/", ObjectSerializer::toString($until)))) {
            throw new \InvalidArgumentException("invalid value for \$until when calling ResTicket., must conform to the pattern /^\\d{14}$/.");
        }
     ...
     * Sets useId2
     *
     * @param bool $useId2 Does this ticket identify the model via its secondary ID (model property `id2`)?
     *
     * @return self
     */
     ...
     * Gets type
     *
     * @return \ShapeDiver\GeometryApiV2\Client\Model\ResTicketType
     */
     ...
     * Sets type
     *
     * @param \ShapeDiver\GeometryApiV2\Client\Model\ResTicketType $type type
     *
     * @return self
     */
     ...
     * Sets modelId
     *
     * @param string $modelId Either the model's `id` or `id2` property, depending on the ticket property `use_id2`.
     *
     * @return self
     */
