...
/**
 * ResAssetUploadHeaders Class Doc Comment
 *
 * @category Class
 ...
 */
class ResAssetUploadHeaders implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResAssetUploadHeaders';
    ...
    {
        $this->setIfExists('contentDisposition', $data ?? [], null);
    ...
    */
     ...
     *
     * @param string|null $contentDisposition The value of the Content-Disposition HTTP header.
     *
     * @return self
     */
    public function setContentDisposition($contentDisposition)
    {
        if (is_null($contentDisposition)) {
            throw new \InvalidArgumentException('non-nullable contentDisposition cannot be null');
        }
