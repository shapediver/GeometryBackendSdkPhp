 ...
 */
class ReqTicket implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReqTicket';
    ...
    protected static $openAPITypes = [
        ...
        'until' => 'string',
        'useId2' => 'bool',
        'type' => '\ShapeDiver\GeometryApiV2\Client\Model\ReqTicketType'
    ];
    ...
    */
    ...
    public function setUntil($until)
    {
        ...
        if ((!preg_match("/^\\d{14}$/", ObjectSerializer::toString($until)))) {
            throw new \InvalidArgumentException("invalid value for \$until when calling ReqTicket., must conform to the pattern /^\\d{14}$/.");
        }
     ...
     * Gets type
     *
     * @return \ShapeDiver\GeometryApiV2\Client\Model\ReqTicketType
     */
     ...
     * Sets type
     *
     * @param \ShapeDiver\GeometryApiV2\Client\Model\ReqTicketType $type type
     *
     * @return self
     */
