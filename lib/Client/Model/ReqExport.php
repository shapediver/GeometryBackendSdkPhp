 ...
 */
class ReqExport implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReqExport';
    ...
    */
    ...
    public function setMaxWaitTime($maxWaitTime)
    {
        ...
        if (($maxWaitTime < 0)) {
            throw new \InvalidArgumentException('invalid value for $maxWaitTime when calling ReqExport., must be bigger than or equal to 0.');
        }
