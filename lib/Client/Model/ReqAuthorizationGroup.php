...
/**
 * ReqAuthorizationGroup Class Doc Comment
 *
 * @category Class
 ...
 */
class ReqAuthorizationGroup implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReqAuthorizationGroup';
    ...
    */
     ...
     * Sets models
     *
     * @param string[]|null $models The model IDs that should form the new authorization group.
     *
     * @return self
     */
     ...
     * Sets users
     *
     * @param string[]|null $users The user IDs that should form the new authorization group.
     *
     * @return self
     */
     ...
     * Sets organizations
     *
     * @param string[]|null $organizations The organization IDs that should form the new authorization group.
     *
     * @return self
     */
