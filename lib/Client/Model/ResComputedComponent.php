...
/**
 * ResComputedComponent Class Doc Comment
 *
 * @category Class
 * @package  ShapeDiver\GeometryApiV2\Client
 * @author   OpenAPI Generator team
 ...
 */
class ResComputedComponent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResComputedComponent';
    ...
    */
     ...
     * Sets component
     *
     * @param string $component ID of the component.
     *
     * @return self
     */
     ...
     * Sets time
     *
     * @param float $time Computation time used.
     *
     * @return self
     */
    public function setTime($time)
    {
        ...
        if (($time < 0)) {
            throw new \InvalidArgumentException('invalid value for $time when calling ResComputedComponent., must be bigger than or equal to 0.');
        }
