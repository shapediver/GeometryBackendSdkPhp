 ...
 */
class ResExport implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResExport';
    ...
    */
    ...
    public function setDelay($delay)
    {
        ...
        if (($delay < 0)) {
            throw new \InvalidArgumentException('invalid value for $delay when calling ResExport., must be bigger than or equal to 0.');
        }
