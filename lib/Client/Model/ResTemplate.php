 ...
 */
class ResTemplate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResTemplate';
    ...
    */
     ...
     * Sets name
     *
     * @param string $name Name of the template, e.g. 'customize-request'.
     *
     * @return self
     */
     ...
     * Sets data
     *
     * @param object $data Template for the request body.
     *
     * @return self
     */
