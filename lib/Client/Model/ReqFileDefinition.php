...
/**
 * ReqFileDefinition Class Doc Comment
 *
 * @category Class
 ...
 */
class ReqFileDefinition implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReqFileDefinition';
    ...
    */
     ...
     * Sets format
     *
     * @param string $format Content-Type (MIME type) of the file to be uploaded.
     *
     * @return self
     */
     ...
     * Sets size
     *
     * @param int $size Size of the file to be uploaded, in bytes.
     *
     * @return self
     */
    public function setSize($size)
    {
        ...
        if (($size < 0)) {
            throw new \InvalidArgumentException('invalid value for $size when calling ReqFileDefinition., must be bigger than or equal to 0.');
        }
