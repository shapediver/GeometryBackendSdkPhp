...
/**
 * ResExportOrDefinition Class Doc Comment
 *
 * @category Class
 ...
 */
class ResExportOrDefinition implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResExportOrDefinition';
    ...
    protected static $openAPITypes = [
        ...
        'dependency' => 'string[]',
        'group' => '\ShapeDiver\GeometryApiV2\Client\Model\CommonsGroup',
        'order' => 'int',
        'tooltip' => 'string',
        'displayname' => 'string',
        'hidden' => 'bool',
        ...
        'msg' => 'string',
        'filename' => 'string',
        'result' => '\ShapeDiver\GeometryApiV2\Client\Model\ResExportResult',
    ...
    */
     ...
     * Gets group
     *
     * @return \ShapeDiver\GeometryApiV2\Client\Model\CommonsGroup|null
     */
     ...
     * Sets group
     *
     * @param \ShapeDiver\GeometryApiV2\Client\Model\CommonsGroup|null $group Group information of an export definition.
     *
     * @return self
     */
     ...
     * Sets typeId
     *
     * @param string|null $typeId Type-specific ID of the export. In case of exports defined by a single component, this corresponds to the component’s uuid.
     *
     * @return self
     */
     ...
     * Sets typeName
     *
     * @param string|null $typeName Type-specific name of the export. In case of exports defined by a single component, this corresponds to the component’s name (NOT its nickname).
     *
     * @return self
     */
     ...
     * Sets delay
     *
     * @param int|null $delay The delay in milliseconds after which an export cache request shall be sent to check again for this export version. This property is used ONLY if the export version has not been computed yet.  Note that the existence of this property does not necessarily imply the presence of an active or queued computation for the respective export version.
     *
     * @return self
     */
    public function setDelay($delay)
    {
        ...
        if (($delay < 0)) {
            throw new \InvalidArgumentException('invalid value for $delay when calling ResExportOrDefinition., must be bigger than or equal to 0.');
        }
     ...
     * Gets content
     *
     * @return \ShapeDiver\GeometryApiV2\Client\Model\ResExportContent[]|null
     */
     ...
     * Sets content
     *
     * @param \ShapeDiver\GeometryApiV2\Client\Model\ResExportContent[]|null $content Result parts. In case this array does not exist, this means that the workers have not finished computation for this output version.
     *
     * @return self
     */
     ...
     * Sets filename
     *
     * @param string|null $filename Optional suggested filename for the files to be downloaded.
     *
     * @return self
     */
     ...
     * Gets result
     *
     * @return \ShapeDiver\GeometryApiV2\Client\Model\ResExportResult|null
     */
     ...
     * Sets result
     *
     * @param \ShapeDiver\GeometryApiV2\Client\Model\ResExportResult|null $result result
     *
     * @return self
     */
     ...
     *
     * @param \ShapeDiver\GeometryApiV2\Client\Model\ResComputationStatus|null $statusComputation Status of the computation which resulted in the export version.
     *
     * @return self
     */
     ...
     * Sets statusCollect
     *
     * @param \ShapeDiver\GeometryApiV2\Client\Model\ResComputationStatus|null $statusCollect Status of collecting results for the export version.
     *
     * @return self
     */
