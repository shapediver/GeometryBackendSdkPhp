...
/**
 * ReqOutputDefinitionChunk Class Doc Comment
 *
 * @category Class
 ...
 */
class ReqOutputDefinitionChunk implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReqOutputDefinitionChunk';
    ...
    */
     ...
     * Sets displayname
     *
     * @param string|null $displayname Chunk name to display instead of the chunk `name`. This value can be unset by specifying an empty string.
     *
     * @return self
     */
     ...
     * Sets hidden
     *
     * @param bool|null $hidden Controls whether the chunk should be hidden in the UI.
     *
     * @return self
     */
