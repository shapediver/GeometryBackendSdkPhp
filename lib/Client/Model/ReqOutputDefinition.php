...
/**
 * ReqOutputDefinition Class Doc Comment
 *
 * @category Class
 ...
 */
class ReqOutputDefinition implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReqOutputDefinition';
    ...
    protected static $openAPITypes = [
        'displayname' => 'string',
        'group' => '\ShapeDiver\GeometryApiV2\Client\Model\ReqOutputDefinitionGroup',
        'hidden' => 'bool',
        'order' => 'int',
        'tooltip' => 'string',
        'chunks' => '\ShapeDiver\GeometryApiV2\Client\Model\ReqOutputDefinitionChunk[]'
    ];
    ...
    */
     ...
     * Gets group
     *
     * @return \ShapeDiver\GeometryApiV2\Client\Model\ReqOutputDefinitionGroup|null
     */
     ...
     * Sets group
     *
     * @param \ShapeDiver\GeometryApiV2\Client\Model\ReqOutputDefinitionGroup|null $group group
     *
     * @return self
     */
     ...
     * Sets hidden
     *
     * @param bool|null $hidden Controls whether the output should be hidden in the UI.
     *
     * @return self
     */
     ...
     * Gets chunks
     *
     * @return \ShapeDiver\GeometryApiV2\Client\Model\ReqOutputDefinitionChunk[]|null
     */
     ...
     * Sets chunks
     *
     * @param \ShapeDiver\GeometryApiV2\Client\Model\ReqOutputDefinitionChunk[]|null $chunks The chunk definitions of the sdTF file that is generated by the output. If specified, all existing sdTF chunks of the output must be given. The order of the given chunk items determines the order in that the chunks will be shown in the UI.
     *
     * @return self
     */
