...
/**
 * ResPluginsLibrary Class Doc Comment
 *
 * @category Class
 ...
 */
class ResPluginsLibrary implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResPluginsLibrary';
    ...
    */
     ...
     * Sets author
     *
     * @param string $author Library author.
     *
     * @return self
     */
     ...
     *
     * @param string|null $assemblyFullName Assembly name (not present in Rhino 5).
     *
     * @return self
     */
     ...
     *
     * @param string|null $assemblyVersion Assembly version (not present in Rhino 5).
     *
     * @return self
     */
