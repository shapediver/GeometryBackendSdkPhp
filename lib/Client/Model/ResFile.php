 ...
 */
class ResFile implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResFile';
    ...
    */
     ...
     * Sets upload
     *
     * @param string|null $upload URL to upload a model file.
     *
     * @return self
     */
     ...
     * Sets download
     *
     * @param string|null $download URL to download a model file.
     *
     * @return self
     */
