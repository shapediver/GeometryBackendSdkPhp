...
/**
 * ResModelSettings Class Doc Comment
 *
 * @category Class
 * @package  ShapeDiver\GeometryApiV2\Client
 * @author   OpenAPI Generator team
 ...
 */
class ResModelSettings implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResModelSettings';
    ...
    protected static $openAPITypes = [
        'useCdn' => 'bool',
        'cdnSupported' => 'bool',
        'blockingReasons' => '\ShapeDiver\GeometryApiV2\Client\Model\ResModelBlockingReasons'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('cdnSupported', $data ?? [], null);
    ...
    */
     ...
     * @return bool|null
     */
    public function getCdnSupported()
    {
        return $this->container['cdnSupported'];
    }

    /**
     * Sets cdnSupported
     *
     * @param bool|null $cdnSupported Indicates if the model supports CDN-based asset URLs.
     *
     * @return self
     */
    public function setCdnSupported($cdnSupported)
    {
        if (is_null($cdnSupported)) {
            throw new \InvalidArgumentException('non-nullable cdnSupported cannot be null');
        }
        $this->container['cdnSupported'] = $cdnSupported;
     ...
     *
     * @return \ShapeDiver\GeometryApiV2\Client\Model\ResModelBlockingReasons|null
     */
     ...
     *
     * @param \ShapeDiver\GeometryApiV2\Client\Model\ResModelBlockingReasons|null $blockingReasons blockingReasons
     *
     * @return self
     */
