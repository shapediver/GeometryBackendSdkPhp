...
/**
 * ReqModelStatistic Class Doc Comment
 *
 * @category Class
 ...
 */
class ReqModelStatistic implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReqModelStatistic';
    ...
    */
    ...
    public function setTimestampFrom($timestampFrom)
    {
        ...
        if ((!preg_match("/^(\\d{4}|\\d{6}|\\d{8}|\\d{10})$/", ObjectSerializer::toString($timestampFrom)))) {
            throw new \InvalidArgumentException("invalid value for \$timestampFrom when calling ReqModelStatistic., must conform to the pattern /^(\\d{4}|\\d{6}|\\d{8}|\\d{10})$/.");
        }
    ...
    public function setTimestampTo($timestampTo)
    {
        ...
        if ((!preg_match("/^(\\d{4}|\\d{6}|\\d{8}|\\d{10})$/", ObjectSerializer::toString($timestampTo)))) {
            throw new \InvalidArgumentException("invalid value for \$timestampTo when calling ReqModelStatistic., must conform to the pattern /^(\\d{4}|\\d{6}|\\d{8}|\\d{10})$/.");
        }
