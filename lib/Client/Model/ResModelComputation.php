...
class ResModelComputation implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets sessionId
     *
     * @param string|null $sessionId ID of the session that triggered this computation.  The value may be redacted, or omitted when the computation is not associated with a session.
     *
     * @return self
     */
     ...
     * Sets chargeUserId
     *
     * @param string|null $chargeUserId Identifier of the user billed for this computation. This may differ from the user who requested it.
     *
     * @return self
     */
     ...
     * Sets chargeOrgId
     *
     * @param string|null $chargeOrgId Identifier of the organization billed for this computation. This may differ from the organization of the user who requested it.
     *
     * @return self
     */
