...
/**
 * ResTextureList Class Doc Comment
 *
 * @category Class
 * @package  ShapeDiver\GeometryApiV2\Client
 * @author   OpenAPI Generator team
 ...
 */
class ResTextureList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResTextureList';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['texture'] === null) {
            $invalidProperties[] = "'texture' can't be null";
        }
     ...
     * Gets texture
     *
     * @return \ShapeDiver\GeometryApiV2\Client\Model\ResTexture[]
     */
     ...
     * Sets texture
     *
     * @param \ShapeDiver\GeometryApiV2\Client\Model\ResTexture[] $texture A directory of model textures.
     *
     * @return self
     */
