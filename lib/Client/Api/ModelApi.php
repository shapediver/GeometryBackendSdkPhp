...
class ModelApi
{
    ...
    public function createModelRequest($reqModel, string $contentType = self::contentTypes['createModel'][0])
    {
        ...
        if (isset($reqModel)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                ...
                try {
                    $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($reqModel), JSON_THROW_ON_ERROR);
                } catch (\JsonException $e) {
                    throw new \InvalidArgumentException('json_encode error: ' . $e->getMessage(), 0, $e);
                }
            } else {
     ...
     *
     * @param  string $modelId Model ID. (required)
     * @param  bool|null $xShapediverNoconvert When set to &#x60;true&#x60;, the config object is returned as stored, without any version conversion applied. [Priority: 1] (optional)
     * @param  string|null $xShapediverUseconfigversion When set to &#x60;true&#x60;, the returned config version will be of the same version as when the config object has been created. In case the version number cannot be extracted from the config object, this header is ignored. [Priority: 2] (optional)
     * @param  string|null $xShapediverBuildversion When specified, converts the requested config object to the provided target version. Otherwise, the config object is converted into the default version instead. [Priority: 3] (optional)
     ...
     */
    public function getModelConfig($modelId, $xShapediverNoconvert = null, $xShapediverUseconfigversion = null, $xShapediverBuildversion = null, string $contentType = self::contentTypes['getModelConfig'][0])
    {
        list($response) = $this->getModelConfigWithHttpInfo($modelId, $xShapediverNoconvert, $xShapediverUseconfigversion, $xShapediverBuildversion, $contentType);
        return $response;
    }
     ...
     */
    public function getModelConfigWithHttpInfo($modelId, $xShapediverNoconvert = null, $xShapediverUseconfigversion = null, $xShapediverBuildversion = null, string $contentType = self::contentTypes['getModelConfig'][0])
    {
        $request = $this->getModelConfigRequest($modelId, $xShapediverNoconvert, $xShapediverUseconfigversion, $xShapediverBuildversion, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getModelConfigAsync($modelId, $xShapediverNoconvert = null, $xShapediverUseconfigversion = null, $xShapediverBuildversion = null, string $contentType = self::contentTypes['getModelConfig'][0])
    {
        return $this->getModelConfigAsyncWithHttpInfo($modelId, $xShapediverNoconvert, $xShapediverUseconfigversion, $xShapediverBuildversion, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getModelConfigAsyncWithHttpInfo($modelId, $xShapediverNoconvert = null, $xShapediverUseconfigversion = null, $xShapediverBuildversion = null, string $contentType = self::contentTypes['getModelConfig'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getModelConfigRequest($modelId, $xShapediverNoconvert = null, $xShapediverUseconfigversion = null, $xShapediverBuildversion = null, string $contentType = self::contentTypes['getModelConfig'][0])
    {
        ...
        // header params
        if ($xShapediverNoconvert !== null) {
            $headerParams['x-shapediver-noconvert'] = ObjectSerializer::toHeaderValue($xShapediverNoconvert);
        }
        // header params
        if ($xShapediverUseconfigversion !== null) {
            $headerParams['x-shapediver-useconfigversion'] = ObjectSerializer::toHeaderValue($xShapediverUseconfigversion);
        }
        // header params
        if ($xShapediverBuildversion !== null) {
            $headerParams['x-shapediver-buildversion'] = ObjectSerializer::toHeaderValue($xShapediverBuildversion);
        }
    ...
    /**
     * Operation getModelSessionsAnalytics
     *
     * Get model session analytics in a time range.
     *
     * @param  string $modelId Model ID. (required)
     * @param  \ShapeDiver\GeometryApiV2\Client\Model\QueryOrder|null $order Order in which to query session analytics items.  _Default:_ &#x60;desc&#x60; (optional)
     * @param  string|null $timestampFrom Open timestamp to query from.  _Default:_ &#x60;0&#x60; (optional)
     * @param  string|null $timestampTo Open timestamp to query to.  _Default:_ &#x60;infinity&#x60; (optional)
     * @param  int|null $limit How many items to return at most.  _Default:_ &#x60;100&#x60; (optional)
     * @param  string|null $offset Continuation token for pagination. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getModelSessionsAnalytics'] to see the possible values for this operation
     *
     * @throws \ShapeDiver\GeometryApiV2\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \ShapeDiver\GeometryApiV2\Client\Model\ResGetModelSessionsAnalytics|\ShapeDiver\GeometryApiV2\Client\Model\ResError
     */
    public function getModelSessionsAnalytics($modelId, $order = null, $timestampFrom = null, $timestampTo = null, $limit = null, $offset = null, string $contentType = self::contentTypes['getModelSessionsAnalytics'][0])
    {
        list($response) = $this->getModelSessionsAnalyticsWithHttpInfo($modelId, $order, $timestampFrom, $timestampTo, $limit, $offset, $contentType);
        return $response;
    }

    /**
     * Operation getModelSessionsAnalyticsWithHttpInfo
     *
     * Get model session analytics in a time range.
     *
     * @param  string $modelId Model ID. (required)
     ...
     * @throws \ShapeDiver\GeometryApiV2\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \ShapeDiver\GeometryApiV2\Client\Model\ResGetModelSessionsAnalytics|\ShapeDiver\GeometryApiV2\Client\Model\ResError, HTTP status code, HTTP response headers (array of strings)
     */
    public function getModelSessionsAnalyticsWithHttpInfo($modelId, $order = null, $timestampFrom = null, $timestampTo = null, $limit = null, $offset = null, string $contentType = self::contentTypes['getModelSessionsAnalytics'][0])
    {
        $request = $this->getModelSessionsAnalyticsRequest($modelId, $order, $timestampFrom, $timestampTo, $limit, $offset, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\ShapeDiver\GeometryApiV2\Client\Model\ResGetModelSessionsAnalytics',
                        $request,
                        $response,
                    );
                default:
    ...
    /**
     * Operation getModelSessionsAnalyticsAsync
     *
     * Get model session analytics in a time range.
     *
     * @param  string $modelId Model ID. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getModelSessionsAnalyticsAsync($modelId, $order = null, $timestampFrom = null, $timestampTo = null, $limit = null, $offset = null, string $contentType = self::contentTypes['getModelSessionsAnalytics'][0])
    {
        return $this->getModelSessionsAnalyticsAsyncWithHttpInfo($modelId, $order, $timestampFrom, $timestampTo, $limit, $offset, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getModelSessionsAnalyticsAsyncWithHttpInfo
     *
     * Get model session analytics in a time range.
     *
     * @param  string $modelId Model ID. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getModelSessionsAnalyticsAsyncWithHttpInfo($modelId, $order = null, $timestampFrom = null, $timestampTo = null, $limit = null, $offset = null, string $contentType = self::contentTypes['getModelSessionsAnalytics'][0])
    {
        $returnType = '\ShapeDiver\GeometryApiV2\Client\Model\ResGetModelSessionsAnalytics';
        $request = $this->getModelSessionsAnalyticsRequest($modelId, $order, $timestampFrom, $timestampTo, $limit, $offset, $contentType);
    ...
    /**
     * Create request for operation 'getModelSessionsAnalytics'
     *
     * @param  string $modelId Model ID. (required)
     * @param  \ShapeDiver\GeometryApiV2\Client\Model\QueryOrder|null $order Order in which to query session analytics items.  _Default:_ &#x60;desc&#x60; (optional)
     * @param  string|null $timestampFrom Open timestamp to query from.  _Default:_ &#x60;0&#x60; (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getModelSessionsAnalyticsRequest($modelId, $order = null, $timestampFrom = null, $timestampTo = null, $limit = null, $offset = null, string $contentType = self::contentTypes['getModelSessionsAnalytics'][0])
    {

        // verify the required parameter 'modelId' is set
        if ($modelId === null || (is_array($modelId) && count($modelId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $modelId when calling getModelSessionsAnalytics'
            );
        }


        if ($timestampFrom !== null && !preg_match("/^\\d{17}$/", $timestampFrom)) {
            throw new \InvalidArgumentException("invalid value for \"timestampFrom\" when calling ModelApi.getModelSessionsAnalytics, must conform to the pattern /^\\d{17}$/.");
        }
        
        if ($timestampTo !== null && !preg_match("/^\\d{17}$/", $timestampTo)) {
            throw new \InvalidArgumentException("invalid value for \"timestampTo\" when calling ModelApi.getModelSessionsAnalytics, must conform to the pattern /^\\d{17}$/.");
        }
        
        if ($limit !== null && $limit > 100) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling ModelApi.getModelSessionsAnalytics, must be smaller than or equal to 100.');
        }
        if ($limit !== null && $limit < 1) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling ModelApi.getModelSessionsAnalytics, must be bigger than or equal to 1.');
        }
        


        $resourcePath = '/api/v2/model/{modelId}/sessions';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
