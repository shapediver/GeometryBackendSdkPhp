...
class ModelApi
{
     ...
     *
     * @param  string $modelId Model ID. (required)
     * @param  \ShapeDiver\GeometryApiV2\Client\Model\QueryOrder $order Order in which to query computation stats items.  _Default:_ &#x60;desc&#x60; (optional)
     * @param  string $timestampFrom Timestamp to query from.  _Default:_ &#x60;0&#x60; (optional)
     * @param  string $timestampTo Timestamp to query to.  _Default:_ &#x60;infinity&#x60; (optional)
     * @param  \ShapeDiver\GeometryApiV2\Client\Model\QueryComputationStatisticsStatus $status Filter computations by the result status.  _Default:_ &#x60;*&#x60; (optional)
     * @param  \ShapeDiver\GeometryApiV2\Client\Model\QueryComputationType $type Filter computations by type.  _Default:_ &#x60;*&#x60; (optional)
     * @param  int $limit How many items to return at most.  _Default:_ &#x60;100&#x60; (optional)
     * @param  bool $strictLimit Whether the limit shall be attained (if there are enough items).  _Default:_ &#x60;false&#x60; (optional)
     ...
     * List models.
     *
     * @param  \ShapeDiver\GeometryApiV2\Client\Model\QueryModelStatus $modelStatus Filter models by &#x60;stat&#x60;. (optional)
     * @param  string $offset Continuation token for pagination. (optional)
     ...
     */
    public function updateParameterDefaultValues($modelId, $requestBody, string $contentType = self::contentTypes['updateParameterDefaultValues'][0])
    {
        list($response) = $this->updateParameterDefaultValuesWithHttpInfo($modelId, $requestBody, $contentType);
        return $response;
    }
     ...
     */
    public function updateParameterDefaultValuesWithHttpInfo($modelId, $requestBody, string $contentType = self::contentTypes['updateParameterDefaultValues'][0])
    {
        $request = $this->updateParameterDefaultValuesRequest($modelId, $requestBody, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateParameterDefaultValuesAsync($modelId, $requestBody, string $contentType = self::contentTypes['updateParameterDefaultValues'][0])
    {
        return $this->updateParameterDefaultValuesAsyncWithHttpInfo($modelId, $requestBody, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateParameterDefaultValuesAsyncWithHttpInfo($modelId, $requestBody, string $contentType = self::contentTypes['updateParameterDefaultValues'][0])
    {
        $returnType = '\ShapeDiver\GeometryApiV2\Client\Model\ResUpdateParameterDefaultValues';
        $request = $this->updateParameterDefaultValuesRequest($modelId, $requestBody, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateParameterDefaultValuesRequest($modelId, $requestBody, string $contentType = self::contentTypes['updateParameterDefaultValues'][0])
    {
