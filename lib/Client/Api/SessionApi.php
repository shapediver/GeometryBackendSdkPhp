...
class SessionApi
{
     ...
     * @param  bool|null $strictValidation When &#x60;false&#x60;, any Model-State parameter that cannot be applied to the model is ignored. However, when set to &#x60;true&#x60;, any validation error will result in an error response.  Defaults to &#x60;false&#x60;. (optional)
     ...
     */
    public function createSessionByModel($modelId, $modelStateId = null, $ignoreUnknownParams = null, $strictValidation = null, $reqCustomizationOrExport = null, string $contentType = self::contentTypes['createSessionByModel'][0])
    {
        list($response) = $this->createSessionByModelWithHttpInfo($modelId, $modelStateId, $ignoreUnknownParams, $strictValidation, $reqCustomizationOrExport, $contentType);
        return $response;
    }
     ...
     */
    public function createSessionByModelWithHttpInfo($modelId, $modelStateId = null, $ignoreUnknownParams = null, $strictValidation = null, $reqCustomizationOrExport = null, string $contentType = self::contentTypes['createSessionByModel'][0])
    {
        $request = $this->createSessionByModelRequest($modelId, $modelStateId, $ignoreUnknownParams, $strictValidation, $reqCustomizationOrExport, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createSessionByModelAsync($modelId, $modelStateId = null, $ignoreUnknownParams = null, $strictValidation = null, $reqCustomizationOrExport = null, string $contentType = self::contentTypes['createSessionByModel'][0])
    {
        return $this->createSessionByModelAsyncWithHttpInfo($modelId, $modelStateId, $ignoreUnknownParams, $strictValidation, $reqCustomizationOrExport, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createSessionByModelAsyncWithHttpInfo($modelId, $modelStateId = null, $ignoreUnknownParams = null, $strictValidation = null, $reqCustomizationOrExport = null, string $contentType = self::contentTypes['createSessionByModel'][0])
    {
        $returnType = '\ShapeDiver\GeometryApiV2\Client\Model\ResCreateSessionByModel';
        $request = $this->createSessionByModelRequest($modelId, $modelStateId, $ignoreUnknownParams, $strictValidation, $reqCustomizationOrExport, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function createSessionByModelRequest($modelId, $modelStateId = null, $ignoreUnknownParams = null, $strictValidation = null, $reqCustomizationOrExport = null, string $contentType = self::contentTypes['createSessionByModel'][0])
    {
     ...
     */
    public function createSessionByTicket($ticketId, $modelStateId = null, $ignoreUnknownParams = null, $strictValidation = null, $reqCustomizationOrExport = null, string $contentType = self::contentTypes['createSessionByTicket'][0])
    {
        list($response) = $this->createSessionByTicketWithHttpInfo($ticketId, $modelStateId, $ignoreUnknownParams, $strictValidation, $reqCustomizationOrExport, $contentType);
        return $response;
    }
     ...
     */
    public function createSessionByTicketWithHttpInfo($ticketId, $modelStateId = null, $ignoreUnknownParams = null, $strictValidation = null, $reqCustomizationOrExport = null, string $contentType = self::contentTypes['createSessionByTicket'][0])
    {
        $request = $this->createSessionByTicketRequest($ticketId, $modelStateId, $ignoreUnknownParams, $strictValidation, $reqCustomizationOrExport, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createSessionByTicketAsync($ticketId, $modelStateId = null, $ignoreUnknownParams = null, $strictValidation = null, $reqCustomizationOrExport = null, string $contentType = self::contentTypes['createSessionByTicket'][0])
    {
        return $this->createSessionByTicketAsyncWithHttpInfo($ticketId, $modelStateId, $ignoreUnknownParams, $strictValidation, $reqCustomizationOrExport, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createSessionByTicketAsyncWithHttpInfo($ticketId, $modelStateId = null, $ignoreUnknownParams = null, $strictValidation = null, $reqCustomizationOrExport = null, string $contentType = self::contentTypes['createSessionByTicket'][0])
    {
        $returnType = '\ShapeDiver\GeometryApiV2\Client\Model\ResCreateSessionByTicket';
        $request = $this->createSessionByTicketRequest($ticketId, $modelStateId, $ignoreUnknownParams, $strictValidation, $reqCustomizationOrExport, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function createSessionByTicketRequest($ticketId, $modelStateId = null, $ignoreUnknownParams = null, $strictValidation = null, $reqCustomizationOrExport = null, string $contentType = self::contentTypes['createSessionByTicket'][0])
    {
