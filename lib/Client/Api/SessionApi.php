...
class SessionApi
{
     ...
     */
    public function createSessionByModel($modelId, $reqCustomizationOrExport = null, string $contentType = self::contentTypes['createSessionByModel'][0])
    {
        list($response) = $this->createSessionByModelWithHttpInfo($modelId, $reqCustomizationOrExport, $contentType);
        return $response;
    }
     ...
     */
    public function createSessionByModelWithHttpInfo($modelId, $reqCustomizationOrExport = null, string $contentType = self::contentTypes['createSessionByModel'][0])
    {
        $request = $this->createSessionByModelRequest($modelId, $reqCustomizationOrExport, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createSessionByModelAsync($modelId, $reqCustomizationOrExport = null, string $contentType = self::contentTypes['createSessionByModel'][0])
    {
        return $this->createSessionByModelAsyncWithHttpInfo($modelId, $reqCustomizationOrExport, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createSessionByModelAsyncWithHttpInfo($modelId, $reqCustomizationOrExport = null, string $contentType = self::contentTypes['createSessionByModel'][0])
    {
        $returnType = '\ShapeDiver\GeometryApiV2\Client\Model\ResCreateSessionByModel';
        $request = $this->createSessionByModelRequest($modelId, $reqCustomizationOrExport, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function createSessionByModelRequest($modelId, $reqCustomizationOrExport = null, string $contentType = self::contentTypes['createSessionByModel'][0])
    {
     ...
     */
    public function createSessionByTicket($ticketId, $reqCustomizationOrExport = null, string $contentType = self::contentTypes['createSessionByTicket'][0])
    {
        list($response) = $this->createSessionByTicketWithHttpInfo($ticketId, $reqCustomizationOrExport, $contentType);
        return $response;
    }
     ...
     */
    public function createSessionByTicketWithHttpInfo($ticketId, $reqCustomizationOrExport = null, string $contentType = self::contentTypes['createSessionByTicket'][0])
    {
        $request = $this->createSessionByTicketRequest($ticketId, $reqCustomizationOrExport, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createSessionByTicketAsync($ticketId, $reqCustomizationOrExport = null, string $contentType = self::contentTypes['createSessionByTicket'][0])
    {
        return $this->createSessionByTicketAsyncWithHttpInfo($ticketId, $reqCustomizationOrExport, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createSessionByTicketAsyncWithHttpInfo($ticketId, $reqCustomizationOrExport = null, string $contentType = self::contentTypes['createSessionByTicket'][0])
    {
        $returnType = '\ShapeDiver\GeometryApiV2\Client\Model\ResCreateSessionByTicket';
        $request = $this->createSessionByTicketRequest($ticketId, $reqCustomizationOrExport, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function createSessionByTicketRequest($ticketId, $reqCustomizationOrExport = null, string $contentType = self::contentTypes['createSessionByTicket'][0])
    {
